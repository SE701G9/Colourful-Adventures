...
const LavaColourMix = () => {
  const [dialogue, setDialogue] = useState({
    name: "Caramel",
    message: "Okay! Let’s find out where we are now.",
  });
  ...
  >([
    {
      name: "Caramel",
      message:
        "Try playing around and combining red and yellow, let’s see what happens~",
    },
  ]);
  ...
  const setUpDialogue = () => {
    addDialogue({
      name: "Picasso",
      message: "L-LAVA!? This was here the whole time!?",
    });
    addDialogue({
      name: "Picasso",
      message: "I… I shouldn’t have mixed red and yellow together.",
    });
    addDialogue({ name: "Picasso", message: "This is…let’s, let’s go back." });
    addDialogue({
      name: "Caramel",
      message: "This just happens to be where we are, silly.",
    });
    addDialogue({
      name: "Caramel",
      message:
        "Look at how you made orange, with the brightness from red and warmness from yellow! Feel that heat!?",
    });
    addDialogue({
      name: "Picasso",
      message: " Orange must be a cursed colour…",
    });
  };
